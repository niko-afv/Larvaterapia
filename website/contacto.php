<div id="contact-form">
    <img src="img/png/contacto/fondo con larva y letras.png"    />
    <form class="span-8" action="form.php" method="post">
        <input type="text" name="nombre" value="" id="nombre" class="input prepend-1 span-6 append-1 last" />
