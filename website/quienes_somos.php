        ...
        <div class="container">
            <div id="q-somos" class="prepend-3 span-19 append-2 last">
                ...
                <div id="q-somos-cont" class="prepend-top span-18 last">
                    ...
                    <p class="span-18">
                        Somos un laboratorio formado por profesionales en el área de la biotecnología, agronomía y entomología, dedicado a la
                        invstigación de insectos. Como principal objetivo buscamos implementar terapias o tratamientos en base a insectos
                        Chilenos, además de generar subproductos biotecnológicos de los mismos,
                        Como empresa nos enfocamos en generar soluciones entomológicas-biotecnológicas a poblemas que existan
                        en empresas de diferentes sectores.
                    </p>
                    
                    <p class="span-19">
                        Actualmente nos encontramos trabajando con la Asociación de Diabéticos de Chile (ADICH), la cual utiliza uno de nuestros
                        productos para el tratamiento complementario de pacientes que padecen úlceras crñonicas, varicosas diabeticas y
